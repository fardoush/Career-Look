...
const FeatureCard = (props) => {
    const {img,jobTitle,companyName,jobType,jobType1,location,salary } = props.feature;
    ...
    return (
      ...
      <div className="card-body text-left">
        ...
        <div className="flex gap-3">
            <div className="">
               <locationIcon></locationIcon> <span className="">{location}</span>
            </div>
            <div className="">
               <salary></salary> <span className="">Salary: {salary}</span>
            </div>
        </div>
